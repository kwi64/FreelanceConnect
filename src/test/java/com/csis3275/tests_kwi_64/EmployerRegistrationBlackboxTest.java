...
public class EmployerRegistrationBlackboxTest {
	...
	public void employerRegistration() throws InterruptedException {
		...
		driver.findElement(By.id("name")).sendKeys("New Employer " + id);
		driver.findElement(By.id("username")).click();
		driver.findElement(By.id("username")).sendKeys("newemployer" + id + "@connect.com");
